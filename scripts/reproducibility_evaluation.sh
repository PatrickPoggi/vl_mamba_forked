...
CUDA_VISIBLE_DEVICES=1 python src/vl_mamba/evaluation/evaluate_vsr.py --dataset_cache_dir cache/datasets/ --root_dataset_path storage/datasets/ --model_name checkpoints/finetuned_mambavl_1.4b/ --split test --output_json results2/finetuned_mambavl_1.4b/vsr_test.json